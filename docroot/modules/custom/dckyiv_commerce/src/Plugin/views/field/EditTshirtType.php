...
/**
 * Defines a form element for editing the order item tshirt type.
 *
 * @ViewsField("commerce_order_item_edit_tshirt_type")
 */
class EditTshirtType extends FieldPluginBase {
  ...
  public function viewsForm(array &$form, FormStateInterface $form_state) {
    ...
    foreach ($this->view->result as $row_index => $row) {
      ...
      $field = $order_item->get('field_t_shirt_type');
